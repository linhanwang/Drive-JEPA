...
def main(cfg: DictConfig) -> None:
    ...
    wandb_logger = WandbLogger(name=cfg.experiment_name, save_dir=cfg.output_dir + '/wandb', project='bench2drive')
    ...
    trainer = pl.Trainer(**cfg.trainer.params, logger=wandb_logger, callbacks=[checkpoint_cb] + agent.get_training_callbacks())
    ...
    trainer.fit(
        ...
        # ckpt_path='/home/linhan/yinlin/projects/navsim_workspace/exp/ke/train_ipad_b2d_baseline/12.21_23.03/checkpoints/best_epoch=16.ckpt'
    )
